...
strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctStimulusControllers.m_hPanel, 40+30*4, ...
 ...
 strctControllers.m_hSetNewBackground = uicontrol('Parent',strctStimulusControllers.m_hPanel,'Style', 'pushbutton', 'String', 'Back Color',...
  ...
  strctControllers.m_hSetNewBackground = uicontrol('Parent',strctStimulusControllers.m_hPanel,'Style', 'pushbutton', 'String', 'Fixation Color',...
     'Position', [2*iButtonWidth+40 iPanelHeight-290 iButtonWidth 30], 'Callback', [g_strctParadigm.m_strCallbacks,'(''FixationColor'');']);
    
 strctControllers.m_hSetNewBackground = uicontrol('Parent',strctStimulusControllers.m_hPanel,'Style', 'pushbutton', 'String', 'Copy StimPos',...
     'Position', [iButtonWidth+20 iPanelHeight-290 iButtonWidth 30], 'Callback', [g_strctParadigm.m_strCallbacks,'(''CopyFixationPosition'');']);
