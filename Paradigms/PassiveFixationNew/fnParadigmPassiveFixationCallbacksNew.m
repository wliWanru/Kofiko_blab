...
switch strCallback
    ...
    case 'CopyFixationPosition'
        global g_astrctAllParadigms
        if isfield(g_astrctAllParadigms{7},'StimulusPos')
         fnTsSetVarParadigm('StimulusPos',g_astrctAllParadigms{7}.StimulusPos.Buffer(1,:,g_astrctAllParadigms{7}.StimulusPos.BufferIdx));
        end
