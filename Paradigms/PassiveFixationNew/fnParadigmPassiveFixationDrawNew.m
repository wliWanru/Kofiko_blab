...
afFixationColor = squeeze(g_strctParadigm.FixationColor.Buffer(1,:,g_strctParadigm.FixationColor.BufferIdx));
...
Screen('FillArc',g_strctPTB.m_hWindow,afFixationColor, g_strctPTB.m_fScale * aiFixationRect,0,360);
