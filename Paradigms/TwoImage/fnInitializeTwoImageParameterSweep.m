...
pt2fStimulusPos_Image1 = fnTsGetVar(g_strctParadigm, 'StimulusPos_Image1');
pt2fStimulusPos_Image2 = fnTsGetVar(g_strctParadigm, 'StimulusPos_Image2');
pt2fStimulusPos_Center = (pt2fStimulusPos_Image1+pt2fStimulusPos_Image2)/2;
...
if isempty(strctSweep.m_afX)
    g_strctParadigm.m_strctParamSweep.m_afXPos = pt2fStimulusPos_Center(1);
else
    g_strctParadigm.m_strctParamSweep.m_afXPos = strctSweep.m_afX;
end

if isempty(strctSweep.m_afY)
    g_strctParadigm.m_strctParamSweep.m_afYPos = pt2fStimulusPos_Center(2);
else
