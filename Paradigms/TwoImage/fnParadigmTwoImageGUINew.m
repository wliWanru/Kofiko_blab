...
strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctStimulusControllers.m_hPanel, 40+30*3, ...
    'Size_Image1:', 'StimulusSizePix_Image1',0, 700,  [1, 50], fnTsGetVar(g_strctParadigm,'StimulusSizePix_Image1'));

strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctStimulusControllers.m_hPanel, 40+30*4, ...
    'Size_Image2:', 'StimulusSizePix_Image2',0, 700,  [1, 50], fnTsGetVar(g_strctParadigm,'StimulusSizePix_Image2'));

strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctStimulusControllers.m_hPanel, 40+30*5, ...
    'Contrast for Image1:', 'Contrast_Image1',0, 100,  [1 10], fnTsGetVar(g_strctParadigm,'Contrast_Image1'));

strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctStimulusControllers.m_hPanel, 40+30*6, ...
    'Contrast for Image2:', 'Contrast_Image2',0, 100,  [1 10], fnTsGetVar(g_strctParadigm,'Contrast_Image2'));

strctControllers.m_hImage1_Text = uicontrol('Parent',strctStimulusControllers.m_hPanel,'Style', 'text', 'String', 'Image1_Position','Position',...
   [5 630 150 20],'HorizontalAlignment','Left');

position_Image1 = fnTsGetVar(g_strctParadigm,'StimulusPos_Image1');

strctControllers.m_hImage1_XEdit = fnMyUIControlEdit('Parent',strctStimulusControllers.m_hPanel,'Style', 'edit','String',num2str(position_Image1(1)),'Position', [25 600 40 20],'Callback',...
    'global g_strctParadigm; fnOnlyEditCallback2(g_strctParadigm.m_strctControllers.m_hImage1_XEdit,''StimulusPos_Image1'',1);'); 

strctControllers.m_hImage1_YEdit = fnMyUIControlEdit('Parent',strctStimulusControllers.m_hPanel,'Style', 'edit','String',num2str(position_Image1(2)),'Position', [25 570+5 40 20],'Callback',...
    'global g_strctParadigm; fnOnlyEditCallback2(g_strctParadigm.m_strctControllers.m_hImage1_YEdit,''StimulusPos_Image1'',2);'); 

strctControllers.m_hImage1_Text = uicontrol('Parent',strctStimulusControllers.m_hPanel,'Style', 'text', 'String', 'Image1_Position','Position',...
   [105 630 150 20],'HorizontalAlignment','Left');

position_Image2 = fnTsGetVar(g_strctParadigm,'StimulusPos_Image2');

strctControllers.m_hImage2_XEdit = fnMyUIControlEdit('Parent',strctStimulusControllers.m_hPanel,'Style', 'edit','String',num2str(position_Image2(1)),'Position', [125 600 40 20],'Callback',...
    'global g_strctParadigm; fnOnlyEditCallback2(g_strctParadigm.m_strctControllers.m_hImage2_XEdit,''StimulusPos_Image2'',1);'); 

strctControllers.m_hImage2_YEdit = fnMyUIControlEdit('Parent',strctStimulusControllers.m_hPanel,'Style', 'edit','String',num2str(position_Image2(2)),'Position', [125 570+5 40 20],'Callback',...
    'global g_strctParadigm; fnOnlyEditCallback2(g_strctParadigm.m_strctControllers.m_hImage2_YEdit,''StimulusPos_Image2'',2);'); 

% strctControllers.m_hImageText= uicontrol('Style', 'text', 'String', 'Image1_X:',...
%     'Position', [5 iPanelHeight-295 ,130 15], 'parent',strctStimulusControllers.m_hPanel,'HorizontalAlignment','left');
% 
% strctControllers.m_hImageText= uicontrol('Style', 'edit', 'String', '412',...
%     'Position', [5 iPanelHeight-295 ,130 15], 'parent',strctStimulusControllers.m_hPanel,'HorizontalAlignment','left',);
