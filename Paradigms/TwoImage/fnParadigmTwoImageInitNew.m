...
% Let us initiate the starting positions of two images side by side with distance 200 pixel 
g_strctParadigm = fnTsAddVar(g_strctParadigm, 'StimulusPos_Image1', [g_strctStimulusServer.m_aiScreenSize(3)/2-100 g_strctStimulusServer.m_aiScreenSize(4)/2] , iSmallBuffer);
g_strctParadigm = fnTsAddVar(g_strctParadigm, 'StimulusPos_Image2', [g_strctStimulusServer.m_aiScreenSize(3)/2+100 g_strctStimulusServer.m_aiScreenSize(4)/2] , iSmallBuffer);

g_strctParadigm = fnTsAddVar(g_strctParadigm, 'Contrast_Image1', 100, iSmallBuffer);
g_strctParadigm = fnTsAddVar(g_strctParadigm, 'Contrast_Image2', 100, iSmallBuffer);

g_strctParadigm = fnTsAddVar(g_strctParadigm, 'StimulusSizePix_Image1', 1, iSmallBuffer); % propotion of the original Image1; Will calculte the Image size in the callback;
g_strctParadigm = fnTsAddVar(g_strctParadigm, 'StimulusSizePix_Image2', 1, iSmallBuffer); % Propotion of the original Image2; Will calculte the Image size in the callback;
...
g_strctParadigm = fnTsAddVar(g_strctParadigm, 'Trials',zeros(8,1),iLargeBuffer);
