...
pt2fStimulusPos_Image1 = g_strctParadigm.StimulusPos_Image1.Buffer(1,:,g_strctParadigm.StimulusPos_Image1.BufferIdx);
pt2fStimulusPos_Image2 = g_strctParadigm.StimulusPos_Image2.Buffer(1,:,g_strctParadigm.StimulusPos_Image2.BufferIdx);
...
fStimulusSizePix_Image1 = g_strctParadigm.StimulusSizePix_Image1.Buffer(1,:,g_strctParadigm.StimulusSizePix_Image1.BufferIdx);
fStimulusSizePix_Image2 = g_strctParadigm.StimulusSizePix_Image2.Buffer(1,:,g_strctParadigm.StimulusSizePix_Image2.BufferIdx);
Contrast_Image1 = g_strctParadigm.Contrast_Image1.Buffer(1,:,g_strctParadigm.Contrast_Image1.BufferIdx);
Contrast_Image2 = g_strctParadigm.Contrast_Image2.Buffer(1,:,g_strctParadigm.Contrast_Image2.BufferIdx);
...
%% Draw Stimulus
if ~isempty(g_strctParadigm.m_strctCurrentTrial) && g_strctParadigm.m_bStimulusDisplayed && isfield(g_strctParadigm.m_strctCurrentTrial,'m_iStimulusIndex_Image1') && ...
        g_strctParadigm.m_iMachineState ~= 6
    % Trial exist. Check state and draw either the image g_strctParadigm.m_strctCurrentTrial
    iMediaToDisplay = g_strctParadigm.m_strctCurrentTrial.m_iStimulusIndex_Image1;
...
aiStimulusRect1 = [pt2fStimulusPos_Image1-fStimulusSizePix_Image1, pt2fStimulusPos_Image1+fStimulusSizePix_Image1];
aiStimulusRect2 = [pt2fStimulusPos_Image2-fStimulusSizePix_Image2, pt2fStimulusPos_Image2+fStimulusSizePix_Image2];
...
Screen('FrameRect',g_strctPTB.m_hWindow,[255 255 0], g_strctPTB.m_fScale * aiStimulusRect1);
Screen('FrameRect',g_strctPTB.m_hWindow,[255 255 0], g_strctPTB.m_fScale * aiStimulusRect2);
...
asdfd
pt2fStimulusPos_Image1 =g_strctParadigm.m_strctCurrentTrial.m_pt2fStimulusPos_Image1;
pt2fStimulusPos_Image2 =g_strctParadigm.m_strctCurrentTrial.m_pt2fStimulusPos_Image2;

fStimulusSizePix_Image1 =g_strctParadigm.m_strctCurrentTrial.m_fStimulusSizePix_Image1;
fStimulusSizePix_Image2 =g_strctParadigm.m_strctCurrentTrial.m_fStimulusSizePix_Image2;

fRotationAngle = 0;

hTexturePointer1 = g_strctParadigm.m_strctDesign.m_astrctMedia(g_strctParadigm.m_strctCurrentTrial.m_iStimulusIndex_Image1).m_aiMediaToHandleIndexInBuffer(1);
hTexturePointer2 = g_strctParadigm.m_strctDesign.m_astrctMedia(g_strctParadigm.m_strctCurrentTrial.m_iStimulusIndex_Image2).m_aiMediaToHandleIndexInBuffer(1);

aiTextureSize1 = g_strctParadigm.m_strctTexturesBuffer.m_a2iTextureSize(:,hTexturePointer1)';
aiTextureSize2 = g_strctParadigm.m_strctTexturesBuffer.m_a2iTextureSize(:,hTexturePointer2)';

aiStimulusRect1 = g_strctPTB.m_fScale * fnComputeStimulusRect(fStimulusSizePix_Image1, aiTextureSize1, pt2fStimulusPos_Image1);
aiStimulusRect2 = g_strctPTB.m_fScale * fnComputeStimulusRect(fStimulusSizePix_Image2, aiTextureSize2, pt2fStimulusPos_Image2);
...
%         
         a2fImage1 = g_strctParadigm.m_strctTexturesBuffer.m_acImages{hTexturePointer1};
         a2fImage2 = g_strctParadigm.m_strctTexturesBuffer.m_acImages{hTexturePointer2};
...
%         hImageID = Screen('MakeTexture', g_strctPTB.m_hWindow,  a2fImage);
        Screen('DrawTexture', g_strctPTB.m_hWindow, hImageID1,[],aiStimulusRect1, fRotationAngle);
        Screen('DrawTexture', g_strctPTB.m_hWindow, hImageID2,[],aiStimulusRect2, fRotationAngle);
% 
         Screen('Close',hImageID1);
                  Screen('Close',hImageID2);

%         
%     else
        % Default presentation mode of images...
%         Screen('DrawTexture', g_strctPTB.m_hWindow, g_strctParadigm.m_strctTexturesBuffer.m_ahHandles(hTexturePointer1),[],aiStimulusRect1, fRotationAngle);
%         Screen('DrawTexture', g_strctPTB.m_hWindow, g_strctParadigm.m_strctTexturesBuffer.m_ahHandles(hTexturePointer2),[],aiStimulusRect2, fRotationAngle);
...
%     end
    ...
    Screen(g_strctPTB.m_hWindow,'DrawText', sprintf('Image %d (%s)',g_strctParadigm.m_strctCurrentTrial.m_iStimulusIndex,...
        g_strctParadigm.m_strctDesign.m_astrctMedia(g_strctParadigm.m_strctCurrentTrial.m_iStimulusIndex).m_strName), pt2fStimulusPos_Image1(1),pt2fStimulusPos_Image1(2), [0 255 0]);
end
