...
switch strCallback
    ...
    case 'FixationPosition'
        fnParadigmToStimulusServer('FixationSpotPosition',fnTsGetVar(g_strctParadigm,'FixationSpotPix'));
        g_strctParadigm.m_pt2fFixationSpot = fnTsGetVar(g_strctParadigm,'FixationSpotPix');
    case 'FixationSpot'
