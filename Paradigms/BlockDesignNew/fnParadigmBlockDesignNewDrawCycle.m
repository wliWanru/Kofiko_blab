...
if ~isempty(acInputFromKofiko)
    ...
    switch strCommand
        ...
        case 'FixationSpotPosition'
            g_strctDraw.m_pt2Fixation = acInputFromKofiko{2};
        case 'AbortRun'
        ...
        case 'ShowFixation'
            ...
            if isfield(g_strctDraw, 'm_pt2Fixation')
                pt2Fixation = g_strctDraw.m_pt2Fixation;
            else
                pt2Fixation = pt2iScreenCenter;
            end
            aiFixationRect = [pt2Fixation - fFixationSize,...
                pt2Fixation+fFixationSize];
...
aiFixationRect = [pt2Fixation - g_strctDraw.m_fFixationSizePix,...
    pt2Fixation + g_strctDraw.m_fFixationSizePix];
