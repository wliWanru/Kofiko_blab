...
pt2iCenter = g_strctStimulusServer.m_aiScreenSize(3:4)/2; % Let it movble
%Edited by PB

fixCenter = g_strctParadigm.FixationSpotPix.Buffer(1,:,g_strctParadigm.FixationSpotPix.BufferIdx);
...
aiGazeRect = [fixCenter-fGazeBoxPix,fixCenter+fGazeBoxPix];
...
aiFixationRect = [fixCenter-fFixationSizePix fixCenter+fFixationSizePix];
