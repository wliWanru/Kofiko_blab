...
strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctStimulusControllers.m_hPanel, 40+30*9, ...
 ...
 strctControllers.m_hSetNewBackground = uicontrol('Parent',strctStimulusControllers.m_hPanel,'Style', 'pushbutton', 'String', 'Back Color',...
     'Position', [2*iButtonWidth+40 iPanelHeight-550 iButtonWidth 30], 'Callback', [g_strctParadigm.m_strCallbacks,'(''BackgroundColor'');']);
 
strctControllers.m_hSetNewFixationColor = uicontrol('Parent',strctStimulusControllers.m_hPanel,'Style', 'pushbutton', 'String', 'Fixation Color',...
     'Position', [2*iButtonWidth+40 iPanelHeight-520 iButtonWidth 30], 'Callback', [g_strctParadigm.m_strCallbacks,'(''FixationColor'');']);

strctControllers.m_hFixationSpotChange = uicontrol('Parent',strctStimulusControllers.m_hPanel,'Style', 'pushbutton', 'String', 'Adjust to RF',...
     'Position',  [iButtonWidth+20 iPanelHeight-520 iButtonWidth 30], 'Callback', [g_strctParadigm.m_strCallbacks,'(''QueryRF'');']);
...
strctControllers.m_hFixationSpotChange = uicontrol('Parent',strctStimulusControllers.m_hPanel,'Style', 'pushbutton', 'String', 'Free Fix Pos',...
     'Position',  [iButtonWidth+20 iPanelHeight-550 iButtonWidth 30], 'Callback', [g_strctParadigm.m_strCallbacks,'(''FixationSpot'');']);
...
strctControllers.m_hStimulusPosChange = uicontrol('Parent',strctStimulusControllers.m_hPanel,'Style', 'pushbutton', 'String', 'Free Stimulus Pos',...
     'Position', [5 iPanelHeight-550 iButtonWidth 30], 'Callback', [g_strctParadigm.m_strCallbacks,'(''StimulusPos'');']);
%uimenu(strctControllers.hImageListContextMenu, 'Label', 'Load List', 'Callback', [g_strctParadigm.m_strCallbacks,'(''LoadList'');']);
strctControllers.m_hLoadFile = uicontrol('Parent',strctStimulusControllers.m_hPanel,'Style', 'pushbutton', 'String', 'Load M File',...
     'Position', [5 iPanelHeight-520 iButtonWidth 30], 'Callback', [g_strctParadigm.m_strCallbacks,'(''LoadList'');']);

 strctControllers.m_hFavroiteLists = uicontrol('Style', 'listbox', 'String', fnCellToCharShort(g_strctParadigm.m_acFavroiteLists),...
    'Position', [5 iPanelHeight-460 ,strctDesignControllers.m_iPanelWidth-10 100], 'parent',strctStimulusControllers.m_hPanel, 'Callback',[g_strctParadigm.m_strCallbacks,'(''LoadFavoriteList'');'],...
...
%strctControllers.m_hFavroiteLists = uicontrol('Style', 'listbox', 'String',{'Singrating Orientation','Bar Orientation','Singrating SpatialFrequency','Singrating Size','Border Owner','RF'},...
...
RFLevel = {'Good Red','OK Green','No Response Blue'};
strctControllers.m_hRFLevel = uicontrol('Style', 'listbox', 'String', RFLevel,...
    'Position', [5 iPanelHeight-265 ,strctDesignControllers.m_iPanelWidth-10 100], 'parent',strctDesignControllers.m_hPanel,...
    'value',1);
...
%     'value',1);
% 
% set(strctControllers.m_hBlockLists,'visible','off');


strctControllers.m_hDrawRF = uicontrol('Style', 'checkbox', 'String', 'DrawRF',...
    'Position', [5 iPanelHeight-270 ,60 20], 'parent',strctDesignControllers.m_hPanel,'Value',g_strctParadigm.m_bDrawRF,'Callback',[g_strctParadigm.m_strCallbacks,'(''DrawRF'');']);

% strctControllers.CenterX_Edit = uicontrol('Style', 'edit', 'String', '',...
%     'Position', [65 iPanelHeight-300 ,60 20], 'parent',strctDesignControllers.m_hPanel,'Value',0);
% 
% strctControllers.CenterX_Text = uicontrol('Style', 'text', 'String', 'CenterX',...
%     'Position', [5 iPanelHeight-300 ,60 20], 'parent',strctDesignControllers.m_hPanel,'Value',0);
% 
% strctControllers.CenterY_Edit = uicontrol('Style', 'edit', 'String', '',...
%     'Position', [185 iPanelHeight-300 ,60 20], 'parent',strctDesignControllers.m_hPanel,'Value',0);
% 
% strctControllers.CenterY_Text = uicontrol('Style', 'text', 'String', 'CenterY',...
%     'Position', [125 iPanelHeight-300 ,60 20], 'parent',strctDesignControllers.m_hPanel,'Value',0);
% 
% strctControllers.Width_Edit = uicontrol('Style', 'edit', 'String', '',...
%     'Position', [65 iPanelHeight-330 ,60 20], 'parent',strctDesignControllers.m_hPanel,'Value',0);
% 
% strctControllers.Width_Text = uicontrol('Style', 'text', 'String', 'Width(Pix)',...
%     'Position', [5 iPanelHeight-330 ,60 20], 'parent',strctDesignControllers.m_hPanel,'Value',0);
% 
% strctControllers.Length_Edit = uicontrol('Style', 'edit', 'String', '',...
%     'Position', [185 iPanelHeight-330 ,60 20], 'parent',strctDesignControllers.m_hPanel,'Value',0);
% 
% strctControllers.Length_Text = uicontrol('Style', 'text', 'String', 'Length(Pix)',...
%     'Position', [125 iPanelHeight-330 ,60 20], 'parent',strctDesignControllers.m_hPanel,'Value',0);
% 
% strctControllers.Orientation_Edit = uicontrol('Style', 'edit', 'String', '',...
%     'Position', [65 iPanelHeight-360 ,60 20], 'parent',strctDesignControllers.m_hPanel,'Value',0);
% 
% strctControllers.Orientation_Text = uicontrol('Style', 'text', 'String', 'Orientation',...
%     'Position', [5 iPanelHeight-360 ,60 20], 'parent',strctDesignControllers.m_hPanel,'Value',0);


strctControllers.m_hClearButton = uicontrol('Style', 'pushbutton', 'String', 'Clear RF',...
    'Position', [5 iPanelHeight-360 ,60 20], 'parent',strctDesignControllers.m_hPanel,'Value',0,'Callback', [g_strctParadigm.m_strCallbacks,'(''ClearRF'');']);
...
%     'Num Trains:', 'NanoStimulatorNumTrainRepeat',0, 20,  [1, 50], fnTsGetVar(g_strctParadigm,'NanoStimulatorNumTrainRepeat'));
% strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctMicroStimControllers.m_hPanel, 40+30*2, ...
%     'InterTrainVal:', 'NanoStimulatorInterTrainInterval',0, 10,  [1, 50], fnTsGetVar(g_strctParadigm,'NanoStimulatorInterTrainInterval'));
% 
% strctControllers = fnAddTextSliderEditComboSmallWithCallback2(strctControllers,strctMicroStimControllers.m_hPanel, 40+30*3, ...
%     'SpikeTrigCnt:', 'NanoStimulatorSpikeTriggerCount',0, 100,  [1, 50], fnTsGetVar(g_strctParadigm,'NanoStimulatorSpikeTriggerCount'));
% 
% strctControllers.m_hMicroStim = uicontrol('Parent',strctMicroStimControllers.m_hPanel,'Style', 'pushbutton', 'String', 'Frequency Sweep (electrical)',...
%      'Position', [5 iPanelHeight-220 2*iButtonWidth 25], 'Callback', [g_strctParadigm.m_strCallbacks,'(''MicroStimFrequencySweep'');']);
% 
% strctControllers.m_hMicroStim2 = uicontrol('Parent',strctMicroStimControllers.m_hPanel,'Style', 'pushbutton', 'String', 'Frequency Sweep (optical)',...
%      'Position', [5 iPanelHeight-250 2*iButtonWidth 25], 'Callback', [g_strctParadigm.m_strCallbacks,'(''MicroStimFrequencySweepOptical'');']);
%  
% strctControllers.m_hMicroStim3 = uicontrol('Parent',strctMicroStimControllers.m_hPanel,'Style', 'pushbutton', 'String', 'Spike Triggered Sweep',...
%      'Position', [5 iPanelHeight-280 2*iButtonWidth 30], 'Callback', [g_strctParadigm.m_strCallbacks,'(''MicroStimDelaySweep'');']);
%  
% strctControllers.m_hMicroStim4 = uicontrol('Parent',strctMicroStimControllers.m_hPanel,'Style', 'pushbutton', 'String', 'Stop Sweeps',...
%      'Position', [5 iPanelHeight-340 2*iButtonWidth 30], 'Callback', [g_strctParadigm.m_strCallbacks,'(''MicroStimStopSweep'');']);
%  
