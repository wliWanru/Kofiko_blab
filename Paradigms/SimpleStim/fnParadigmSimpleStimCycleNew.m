    ...
    case 2
        ...
        % Set Next "trial" (image on->off)
         if g_strctParadigm.m_bRepeatNonFixatedImages && ~g_strctParadigm.m_bJustLoaded && ...
            ...
            g_strctParadigm.m_strctCurrentTrial = fnSimpleStimPrepareTrial();
         end
        ...
        % starting by sending a strobe word to plexon....
            ...
            fnParadigmToKofikoComm('TrialStart',g_strctParadigm.m_strctCurrentTrial.Image_index);  
        ...
        % Update status line
%         if strcmpi(g_strctParadigm.m_strctCurrentTrial.m_strctMedia_Image1.m_strMediaType,'Movie') || strcmpi(g_strctParadigm.m_strctCurrentTrial.m_strctMedia_Image1.m_strMediaType,'StereoMovie')             
%              hTexturePointer = g_strctParadigm.m_strctCurrentTrial.m_strctMedia_Image1.m_aiMediaToHandleIndexInBuffer(1);
...
%             g_strctParadigm.m_strctCurrentTrial.m_iStimulusIndex_Image1,...
%             g_strctParadigm.m_strctCurrentTrial.m_iStimulusIndex_Image2,...
...
%                   
%        else
%         fnParadigmToKofikoComm('SetParadigmState', sprintf(', Image %d (%d/%d), Block Time: (%.1f / %.1f) Sec', ...
%             g_strctParadigm.m_iCurrentBlockIndexInOrderList,...
%             iNumBlocks,...
%             strBlockName,...
%             g_strctParadigm.m_iNumTimesBlockShown,...
...
%             
           ...
           fnParadigmToStatServerComm('Send','TrialEnd');
            ...
            % recovered later.
            aiTrialStoreInfo = [g_strctParadigm.m_strctCurrentTrial.Image_index,...
...
if g_strctParadigm.m_bDrawRF && strctInputs.m_abMouseButtons(3) && strctInputs.m_bMouseInPTB
    pos = g_strctParadigm.StimulusPos.Buffer(1,:,g_strctParadigm.StimulusPos.BufferIdx);
    S_X = g_strctParadigm.StimulusSizePix_X.Buffer(1,:,g_strctParadigm.StimulusSizePix_X.BufferIdx);
    S_Y = g_strctParadigm.StimulusSizePix_Y.Buffer(1,:,g_strctParadigm.StimulusSizePix_Y.BufferIdx);
    RectColor =  get(g_strctParadigm.m_strctControllers.m_hRFLevel,'Value');
    g_strctParadigm.m_ToDrawRF(end+1,:) = [pos S_X S_Y RectColor];           
end;
