...
data_dir = 'K:\data\project_data\ephys\240118\RAW';

data_fnames = cellfun(@(x) fullfile(data_dir, sprintf('F240118-%04d.mat', x)), num2cell(2), 'UniformOutput', false);
...
strSessionName = '240118_111111_MaoDan'; 
...
out_fname = fullfile(data_dir, sprintf('ao_extracted_F240118.mat'));
