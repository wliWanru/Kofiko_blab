...
xlabel('TwoImage');
ylabel('RightImage');
title(['Coeffiency between TwoImage and RightImage is ' sprintf('%3.3g',tt)]);
...
xlabel('TwoImage');
ylabel('leftImage');
title(['Coeffiency between TwoImage and leftImage is ' sprintf('%3.3g',tt)]);
...
xlabel('leftImage');
ylabel('RightImage');
title(['Coeffiency between leftImage and RightImage is ' sprintf('%3.3g',tt)]);

subplot(2,3,4);
plot(fr(:,2),fr(:,4),'.');
[tt p] = corrcoef(fr(:,2),fr(:,4));
tt = tt(1,2);
xlabel('RightImage');
ylabel('RightImagewithobj');
title(['Coeffiency between RightImage and RightImagewithobj is ' sprintf('%3.3g',tt)]);
...
xlabel('TwoImage');
ylabel('RightImagewithobj');
title(['Coeffiency between TwoImage and RightImagewithobj is ' sprintf('%3.3g',tt)]);
...
legend('TwoImage','Down','Up','TwoImagewo');
