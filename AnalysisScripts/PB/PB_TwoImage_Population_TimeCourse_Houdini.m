...
for i = 1:length(dd)
    ...
    for j = 1:length(unitnumber)
        ...
        [ExpDate unitstr]
        output = PB_TwoImage_SingleUnit_TimeCourse(Subject,'test',ExpDate,unitstr,24)
        if ~isnan(output)
...
save('D:\PB\TwoImageResult\Houdini_AL_TimeCourse_population.mat', 'finalresult');


return;
clear all;
figure;
load('D:\PB\TwoImageResult\Houdini_AL_TimeCourse_population.mat');
