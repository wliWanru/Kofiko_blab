...
for bc = 1:2
    for i = 1:3
        ...
        for j = 1:2
            ...
            se = squeeze(sn(bc,i,j,:,:))/(size(response,6)-1);
...
%             end
            errorbar(10:20:90,resp(:,1),se(:,1),cc{j},'linewidth',2);
            errorbar(10:20:90,resp(:,2),se(:,2),cc{3-j},'linewidth',2);
            errorbar(10:20:90,resp(:,3),se(:,3),'ko-','linewidth',2);
            set(gca,'FontSize',12);
        end
    end
end
