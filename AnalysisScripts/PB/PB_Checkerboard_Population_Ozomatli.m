...
dd = {'150311'};
Unitlist{1} = [3:5 8 10 12 24 26 27];
...
for i = 1:length(dd)
    ...
    for j = 1:length(unitnumber)
        ...
        [ExpDate unitstr]
        fr = PB_CheckerboardMovie_SingleUnit(Subject,[],ExpDate,unitstr,0)
        if ~isnan(fr)
...
save('D:\PB\CheckerboardMovie\Ozomatli_population.mat', 'finalresult');

return;

load('D:\PB\CheckerboardMovie\Ozomatli_population.mat');
