...
dd = {'160203','160209','160210','160212'}
...
save('C:\PB\RotationImages\Fez_RotationImage_CLH_population.mat', 'finalresult');

return;

clear all;
load('C:\PB\RotationImages\Fez_RotationImage_CLH_population.mat');
