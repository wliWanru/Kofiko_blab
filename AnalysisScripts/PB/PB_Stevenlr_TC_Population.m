...
dd = {'150501','150506','150510'};
Unitlist{1} = [1:11 16];
Unitlist{2} = [1:4 6:12 15 16 18 20];
Unitlist{3} = [5:7 16:27 29 30 34];
Subject = 'Rocco';
...
for i = 1:length(dd)
    ...
    for j = 1:length(unitnumber)
        ...
        [ExpDate unitstr]
        output = PB_Stevenlr_TC_SingleUnit(Subject,'Test',ExpDate,unitstr)
...
save('D:\PB\Stevenlr\Rocco_TC_population.mat', 'finalresult');
...
rr = imresize(rr,[300 300],'nearest');
imshow(rr'/1000);
colormap('default');
set(gca,'clim',[0 1]);
