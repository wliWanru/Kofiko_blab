...
load('C:\PB\Stevenlr\Rocco_population.mat');
...
save('C:\PB\Stevenlr\Rocco_SVR_own.mat','pred_pp_own_all');
% figure;
...
save('C:\PB\Stevenlr\Rocco_SVR_between.mat','pred_pp_between_all');
% for t1 = 1:4
%     figure;
%     for cond = 1:4
