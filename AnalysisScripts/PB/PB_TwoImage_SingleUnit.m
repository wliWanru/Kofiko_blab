function output = OcclusionAnalysis(subjID,experiment,foldername,unitnumber,stimarea)
close all;
if nargin < 5
    stimarea = [60 220];
end
...
if ~isempty(experiment)
    matpath = ['D:\PB2\EphysData\' subjID '\' experiment '\' foldername '\Processed\SingleUnitDataEntries\'];
else
    matpath = ['D:\PB2\EphysData\' subjID '\' foldername '\Processed\SingleUnitDataEntries\'];
end
