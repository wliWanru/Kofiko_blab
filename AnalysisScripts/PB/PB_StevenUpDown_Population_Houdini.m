...
dd = {'150512','150515','150519','150521'};
Unitlist{1} = [1 2 3 8 9];
Unitlist{2} = [4 5 6 7 8 9 10 11 13 15 18 19 20];
Unitlist{3} = [11 12 32];
Unitlist{4} = [4 5 6 8 9 10 11 13 22];
...
save('D:\PB\StevenUpDown\Houdini_AL_population.mat', 'finalresult');
