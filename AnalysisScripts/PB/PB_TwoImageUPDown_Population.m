...
save('C:\PB\TwoImageResult\Rocco_TwoImageUpDown_population.mat', 'finalresult');

return;
clear all;
load('C:\PB\TwoImageResult\Ozomatli_TwoImageUpDown_population.mat');
...
cc = {'ko--','ro-','bo-'};
for j = 1:3;
    plot(10:20:90,squeeze(RR(:,j)),cc{j},'linewidth',1);
    hold on;
end
