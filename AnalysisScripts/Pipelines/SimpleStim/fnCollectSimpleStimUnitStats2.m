...
iParadigmIndex = fnFindParadigmIndex(strctKofiko,'Simple Stim');
...
[a2bStimulusToCondition,acConditionNames,strImageListDescrip] = fnLoadSimpleStimFile(strListName);
...
iEndAvg = find(aiPeriStimulusRangeMS>=max(strctStimulusParams.m_afStimulusON_ALL_MS),1,'first');
strctUnit.iStart = strctConfig.m_strctParams.m_iStartAvgMS;
strctUnit.iEnd = max(strctStimulusParams.m_afStimulusON_ALL_MS);
...
strctUnit.m_strParadigm = 'Simple Stim';
...
if isfield(strctKofiko.g_astrctAllParadigms{iParadigmIndex},'StimulusSizePix')
  ...
  afStimulusSizePix_X = fnTimeZoneChangeTS_Resampling(strctKofiko.g_astrctAllParadigms{iParadigmIndex}.StimulusSizePix_X, 'Kofiko','Plexon',afPlexonTime, strctSync);
    afStimulusSizePix_Y = fnTimeZoneChangeTS_Resampling(strctKofiko.g_astrctAllParadigms{iParadigmIndex}.StimulusSizePix_Y, 'Kofiko','Plexon',afPlexonTime, strctSync);
    afStimulusSizePix = max(afStimulusSizePix_X,afStimulusSizePix_Y);
end
...
strctStimulusParams.m_afStimulusSizePix = fnMyInterp1(strctKofiko.g_astrctAllParadigms{iParadigmIndex}.StimulusSizePix.TimeStamp, ...
    ...
    strctStimulusParams.m_afStimulusSizePix_X = fnMyInterp1(strctKofiko.g_astrctAllParadigms{iParadigmIndex}.StimulusSizePix_X.TimeStamp, ...
    strctKofiko.g_astrctAllParadigms{iParadigmIndex}.StimulusSizePix_X.Buffer, afTimeStamps);
    strctStimulusParams.m_afStimulusSizePix_Y = fnMyInterp1(strctKofiko.g_astrctAllParadigms{iParadigmIndex}.StimulusSizePix_Y.TimeStamp, ...
    strctKofiko.g_astrctAllParadigms{iParadigmIndex}.StimulusSizePix_X.Buffer, afTimeStamps);
end
    

strctStimulusParams.m_afOrientation = fnMyInterp1(strctKofiko.g_astrctAllParadigms{iParadigmIndex}.Orientation.TimeStamp, ...
    strctKofiko.g_astrctAllParadigms{iParadigmIndex}.Orientation.Buffer, afTimeStamps);
% %
...
% end
strctStimulusParams.m_afTF_HZ = fnMyInterp1(strctKofiko.g_astrctAllParadigms{iParadigmIndex}.TF_HZ.TimeStamp, ...
    strctKofiko.g_astrctAllParadigms{iParadigmIndex}.TF_HZ.Buffer, afTimeStamps);

strctStimulusParams.m_afSF_CyclePerDeg = fnMyInterp1(strctKofiko.g_astrctAllParadigms{iParadigmIndex}.SF_CyclePerDeg.TimeStamp, ...
    strctKofiko.g_astrctAllParadigms{iParadigmIndex}.SF_CyclePerDeg.Buffer, afTimeStamps);
strctStimulusParams.m_afContrast = fnMyInterp1(strctKofiko.g_astrctAllParadigms{iParadigmIndex}.Contrast.TimeStamp, ...
    strctKofiko.g_astrctAllParadigms{iParadigmIndex}.Contrast.Buffer, afTimeStamps);

strctStimulusParams.m_afSurfaceColor = fnMyInterp1(strctKofiko.g_astrctAllParadigms{iParadigmIndex}.SurfaceColor.TimeStamp, ...
    strctKofiko.g_astrctAllParadigms{iParadigmIndex}.SurfaceColor.Buffer, afTimeStamps);

strctStimulusParams.m_afBarWidth = fnMyInterp1(strctKofiko.g_astrctAllParadigms{iParadigmIndex}.BarWidth.TimeStamp, ...
    strctKofiko.g_astrctAllParadigms{iParadigmIndex}.BarWidth.Buffer, afTimeStamps);
