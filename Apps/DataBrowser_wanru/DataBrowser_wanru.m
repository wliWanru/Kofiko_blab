    function varargout = DataBrowser_wanru(varargin)
%
...
% DATABROWSER_WANRU M-file for DataBrowser_wanru.fig
%      DATABROWSER_WANRU, by itself, creates a new DATABROWSER_WANRU or raises the existing
%      singleton*.
%
%      H = DATABROWSER_WANRU returns the handle to a new DATABROWSER_WANRU or the handle to
%      the existing singleton*.
%
%      DATABROWSER_WANRU('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in DATABROWSER_WANRU.M with the given input arguments.
%
%      DATABROWSER_WANRU('Property','Value',...) creates a new DATABROWSER_WANRU or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before DataBrowser_wanru_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to DataBrowser_wanru_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help DataBrowser_wanru

% Last Modified by GUIDE v2.5 18-Jan-2024 22:25:57

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @DataBrowser_wanru_OpeningFcn, ...
    'gui_OutputFcn',  @DataBrowser_wanru_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before DataBrowser_wanru is made visible.
function DataBrowser_wanru_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to DataBrowser_wanru (see VARARGIN)
global g_strDataBrowserSavedSessionFile
dbstop if error

% Choose default command line output for DataBrowser_wanru
...
% UIWAIT makes DataBrowser_wanru wait for user response (see UIRESUME)
...
function varargout = DataBrowser_wanru_OutputFcn(hObject, eventdata, handles)
...
% --------------------------------------------------------------------
function hRawAnalyzeLocally_Callback(hObject, eventdata, handles)
% hObject    handle to hRawAnalyzeLocally (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
