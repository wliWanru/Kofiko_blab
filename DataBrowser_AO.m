...
if double(strctTmp2.KeyChar(1)) == 32
    ...
    for iDataIter=1:length(aiSelected)
        ...
        if exist(acDisplayedEntries{iSelectedEntry}.m_strFile,'file')
            ...
            %strctData = load(D:\kofiko_wanru\20240120_tutu\Processed\SingleUnitDataEntries\Unit_007_Entry_002.mat");
        else
        ...
        try
            ...
            strctDataField.m_strDisplayFunction = 'fnDisplaySimpleStim';
